...
const Services = () => {
  const items = [
  {
    ...
    tag: 'Primary Offer',
    desc: 'The foundation: sales process audits, prospect strategy, pipeline creation, revenue forecasting, scripts, and team coaching. Built to turn relationships into measurable growth.',
  ...
  },
  {
    ...
    tag: 'Add-On',
    desc: 'Secure sponsorships, build affiliate partnerships, and shape strategic collaborations. Brand identity assistance and website analysis included.',
    service: 'Brand Partnerships'
  },
  {
    icon: 'megaphone',
    title: 'Awareness & Fundraising',
    tag: 'For Nonprofits',
    desc: 'Donor outreach strategy, sponsorship packages, campaign messaging, and community engagement — designed for organizations with mission at the center.',
    service: 'Awareness & Fundraising'
  },
  {
    icon: 'inbox',
    title: 'Done-For-You Outreach',
    tag: 'Execution',
    desc: 'I run the campaigns. Cold email, LinkedIn prospecting, warm introductions, follow-up systems, appointment setting, and event planning.',
...
<Section id="results" bg={C.cream} py={130}>
    <div style={{ textAlign: 'center', maxWidth: 760, margin: '0 auto 70px' }}>
      ...
      lineHeight: 1, letterSpacing: '-0.012em', margin: '18px 0 0', color: C.ink
        ...
        Nine years. Six promotions. <em style={{ color: C.accent, fontStyle: 'italic' }}>One thesis:</em>
      </h2>
      <p style={{ fontFamily: f.display, fontStyle: 'italic', fontSize: 26, color: C.ink2, marginTop: 20 }}>
...
<Section id="kindwords" bg={C.creamDeep} py={120}>
    <div style={{ textAlign: 'center', marginBottom: 56 }}>
      <Kicker>From Clients</Kicker>
      <h2 className="mwc-display-md" style={{
      fontFamily: f.display, fontWeight: 400, fontSize: 56,
      lineHeight: 1, letterSpacing: '-0.012em', margin: '18px 0 0', color: C.ink
    }}>
        Kind <em style={{ color: C.accent, fontStyle: 'italic' }}>Words</em>
      </h2>
    ...
    <div className="mwc-stack-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32 }}>
      {[
    {
      quote: "Michelle raised awareness for the Guitar Center Foundation by reaching over 2.4 million people. Her ability to bridge corporate infrastructure with creative execution — and to bring the right relationships to the table — is rare.",
      name: "Guitar Center Foundation",
      role: "Strategic Partnership · 2025"
    },
    {
      quote: "Working with Michelle was the difference between guessing and growing. She built our outreach system, opened doors I couldn't have opened on my own, and stayed in our corner through every quarter.",
      name: "Client Name",
      role: "Founder · Placeholder Testimonial"
    }].
    map((t, i) =>
    <div key={i} style={{
        ...
        lineHeight: 1.5, color: C.ink, margin: 0
          ...
          fontFamily: f.display, fontSize: 18, color: C.ink
            ...
            <div>
              ...
              <div style={{ fontFamily: f.body, fontSize: 11, letterSpacing: '0.22em', textTransform: 'uppercase', color: C.accent, marginTop: 4, fontWeight: 500 }}>{t.role}</div>
            </div>
          </div>
        </div>
    )}
...
<Section id="process" bg={C.ink} color={C.cream} py={130} style={{ position: 'relative', overflow: 'hidden' }}>
    ...
    <div className="mwc-stack-3" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 40, position: 'relative' }}>
      {[
    { n: '01', icon: 'calendar', title: 'Get in Touch', body: "It's simple — describe what you're working on and book a 30-minute discovery call. Free, no pitch." },
    { n: '02', icon: 'map', title: 'Receive a Plan', body: 'After our call, you\'ll get a custom plan with the exact next steps for your goals, your stage, and your budget.' },
...
const FooterCTA = () =>
<section id="book" className="mwc-section" style={{ background: C.cream, padding: '120px 0 60px', position: 'relative', overflow: 'hidden' }}>
    <DiamondFade size={620} opacity={0.4} style={{
    position: 'absolute', top: -100, right: '-8%', pointerEvents: 'none'
  }} />
    <div className="mwc-section-pad" style={{ maxWidth: 1240, margin: '0 auto', padding: '0 48px', textAlign: 'center', position: 'relative' }}>
      ...
      <h2 className="mwc-display-cta" style={{
      fontFamily: f.display, fontWeight: 400, fontSize: 84,
      lineHeight: 0.96, letterSpacing: '-0.018em', margin: '22px 0 0', color: C.ink
    }}>
        Let's build something<br />
        <em style={{ color: C.accent, fontStyle: 'italic' }}>worth selling.</em>
      </h2>
      <p style={{ fontFamily: f.body, fontSize: 17, lineHeight: 1.65, color: C.ink2, maxWidth: 540, margin: '30px auto 0' }}>
        Book a free 30-minute discovery call. Bring your goals, current
        outreach, and questions — I'll come prepared with first thoughts.
      </p>
      <div className="mwc-form-actions" style={{ marginTop: 42, display: 'inline-flex', alignItems: 'center', gap: 22, flexWrap: 'wrap', justifyContent: 'center' }}>
        <Btn href="contact.html" size="lg">Book a Discovery Call</Btn>
        <span style={{ fontFamily: f.body, fontSize: 13, color: C.muted }}>
          or write directly →&nbsp;
          <a href="mailto:michelle.wolff57@gmail.com" style={{ color: C.ink, textDecoration: 'underline', textUnderlineOffset: 3 }}>
            michelle.wolff57@gmail.com
          </a>
        </span>
      </div>
    </div>
